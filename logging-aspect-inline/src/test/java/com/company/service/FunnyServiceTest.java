...
public class FunnyServiceTest 
	{
	private FunnyService unitUnderTest;
	
	public @BeforeClass void setUp ( ) 
		{
		unitUnderTest = new FunnyService ( );
		}
	
	public @Test void test_makeFun ( ) 
		{
		unitUnderTest.makeFun ( );
		}
	
	@Test ( expectedExceptions = UnsupportedOperationException.class )
	public void test_makeGun ( ) 
		{
		unitUnderTest.makeGun ( );
		}
	}
